...
if(EMSCRIPTEN)
    set(wxUSE_SOUND_DEFAULT OFF)
else()
    set(wxUSE_SOUND_DEFAULT ON)
endif()
wx_option(wxUSE_SOUND "use wxSound class" ${wxUSE_SOUND_DEFAULT})
...
if(EMSCRIPTEN)
    set(wxUSE_PROPGRID_DEFAULT OFF)
else()
    set(wxUSE_PROPGRID_DEFAULT ON)
endif()
wx_option(wxUSE_PROPGRID "use wxPropertyGrid library" ${wxUSE_PROPGRID_DEFAULT})
...
if(EMSCRIPTEN)
    set(wxUSE_POSTSCRIPT_DEFAULT OFF)
else()
    set(wxUSE_POSTSCRIPT_DEFAULT ON)
endif()
wx_option(wxUSE_POSTSCRIPT "use wxPostscriptDC device context (default for gtk+)" ${wxUSE_POSTSCRIPT_DEFAULT})
...
if(EMSCRIPTEN)
    set(wxUSE_DRAGIMAGE_DEFAULT OFF)
else()
    set(wxUSE_DRAGIMAGE_DEFAULT ON)
endif()
wx_option(wxUSE_DRAGIMAGE "use wxDragImage" ${wxUSE_DRAGIMAGE_DEFAULT})
