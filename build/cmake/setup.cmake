...
if(EMSCRIPTEN)
    # Emscripten check_type_size fails due to -fPIC relocation issues,
    # so we hardcode the known WASM32 type sizes.
    set(SIZEOF_SIZE_T 4)
    set(SIZEOF_SIZE_T_CODE "#define SIZEOF_SIZE_T 4")
    set(SIZEOF_WCHAR_T 4)
    set(SIZEOF_WCHAR_T_CODE "#define SIZEOF_WCHAR_T 4")
    set(SIZEOF_INT 4)
